        ...
        <Marquee className="w-full my-10">
            {
                partners.map((i, index) => (
                    <Image src={i.url} alt="" width={100} height={100} key={index} className="mx-14 grayscale-[100%] w-[120px] h-[120px] object-contain hover:grayscale-0 transition-opacity cursor-pointer"/>
                ))
            }
        </Marquee>
        </div>
